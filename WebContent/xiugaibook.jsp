...
<tr height="15%">
	<td align="center"><font size="7"   face="宋体"><strong>修改图书</strong></font><br></td>
</tr>
...
<tr  align="center">
	<td>图书名称:</td>
	<td colspan="2"><input type="text" value="java"/></td>
</tr>
<tr  align="center">
	<td>图书价格:</td>
	<td colspan="2"><input type="text"value="55.0" /></td>
</tr>
<tr  align="center">
	<td>出版社:</td>
	<td colspan="2"><input type="text" value="北大出版社"/></td>
</tr>
<tr  align="center">
	<td>状态:</td>
...
<tr  align="center">
	<td>借书人:</td>
	<td colspan="2"><input type="text" value="张三" /></td>
</tr>
<tr  align="center">
